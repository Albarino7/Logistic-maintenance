...
Page({
  ...
  data: {
    ...
    show_3: false,
    show_4: false,
    columns_1: ['公寓1栋', '公寓2栋', '公寓3栋', '公寓4栋', '公寓5栋', '公寓6栋', '公寓7栋', '公寓8栋', '公寓9栋', '公寓10栋', '公寓11栋', '公寓12栋', '公寓13栋', '公寓14栋', '公寓15栋', '公寓16栋', '公寓17栋', '公寓18栋', '公寓19栋', '公寓20栋', '公寓21栋', '公寓23栋', '公寓24栋', '留学生公寓22栋', '博士公寓'],
    columns_2: [
      {
  ...
  UploadBtntap: function (e) {
    ...
    var buildNreg = /^([1-5][3][0])|([1-5][1-2]\d{1})|([1-5][0][1-9])$/;//正则判断
    var fault = this.data.fault;
    var fault_detial = this.data.fault_d;
    var res_date = this.data.c_date;
    var res_time = this.data.c_time;
    if (build==='') {
      Toast.fail('请选择要报修的宿舍楼');
      
    }  else if (buildN === '') {
      Toast.fail('请选择要维修的宿舍');
      
    } else if (!buildNreg.test(buildN)) {
      Toast.fail('请输入正确的宿舍门牌号');
