...
const array_2 = {
  '图书馆': ['其他', '一楼IC(书香苑)', '一楼东南(政治-法律类)', '二楼西南(社科总论类)', '二楼北东半(哲学-文学-艺术类)', '二楼北西半(哲学-文学-艺术类)', '二楼东南(文体科教类)', '三楼西南(马克思主义理论)', '三楼北东半(经济类)', '三楼北西半(经济类)', '三楼东南(报纸-期刊)', '四楼西南(工业技术类)', '四楼东南(语言-文字类)', '四楼IC(南北区)', '五楼西南(外文文献)', '五楼东南(自科-综合类)', '五楼IC(南区)', '五楼IC(北区)'],
  '美术馆': ['其他', '一层', '二层', '三层'],
  '音乐厅': ['其他', '厅1', '厅2', '厅3'],
  '风雨操场': ['其他', '一层', '二层', '三层'],
  '大学生活动中心': ['其他', '101', '102', '103', '104', '105', '201', '202', '203', '204', '205', '301', '302', '303', '304', '305', '401', '402', '403', '404', '405', ],
};
